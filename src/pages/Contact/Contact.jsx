...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "6c27a2ff-0548-4c86-946d-d82ab9961c0c"); // updated access key here
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">likithaputtaswamy20@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Glasgow, Scotland, UK</p>
                  </div>
                </div>
              </div>
            </div>
