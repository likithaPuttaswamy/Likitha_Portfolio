...
export default function Header() {
  ...
  const navLinks = [
    ...
    { id: "skills", icon: FaCode, text: "Skills", path: "/skills" }, // ✅ Added Skills
    { id: "experience", icon: FaBriefcase, text: "Experience", path: "/experience" },
    { id: "education", icon: FaGraduationCap, text: "Education/Certifications", path: "/education" },
        ...
        <div className="p-[2px] md:rounded-full bg-gradient-to-r from-emerald-400 via-cyan-500 to-indigo-500 animate-gradient-x">
          <nav className="bg-gray-900/90 backdrop-blur-md md:rounded-full px-4 md:px-6 py-2.5">
            ...
            <div className="flex justify-between items-center md:hidden px-2">
              <Link to="/" className="text-white font-bold text-lg">Likitha</Link>
              <button 
